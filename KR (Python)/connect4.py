...
class Joc:
    ...
    def verif(self, lista, indice, simbol, identare):
        return lista[indice] == simbol and \
            lista[indice + identare] == simbol and \
            lista[indice + 2 * identare] == simbol and \
            lista[indice + 3 * identare] == simbol

    def verif2(self, lista, indice, listaVerif, identare):
        return lista[indice] != listaVerif and \
            lista[indice + identare] != listaVerif and \
            lista[indice + 2 * identare] != listaVerif and \
            lista[indice + 3 * identare] != listaVerif
    ...
    def final(self):
        ...
        for i in range(self.NR_LINII):
            for j in range(self.NR_COLOANE - 3):
                ...
                ind = i * self.NR_COLOANE + j

                if self.verif(self.matr, ind, 'X', 1):
                    return 'X'
                if self.verif(self.matr, ind, '0', 1):
                    return '0'


        # verificam coloane
        for i in range(self.NR_LINII - 3):
            for j in range(self.NR_COLOANE):

                ind = i * self.NR_COLOANE + j

                if self.verif(self.matr, ind, 'X', 7):
                    return 'X'
                if self.verif(self.matr, ind, '0', 7):
                    return '0'
        ...
        for i in range(self.NR_LINII - 3):
            for j in range(self.NR_COLOANE - 3):
                ...
                if self.verif(self.matr, ind, 'X', 8):
                    return 'X'
                if self.verif(self.matr, ind, '0', 8):
                    return '0'

        # verificam diagonale /
        for i in range(self.NR_LINII - 3):
            for j in range(3, self.NR_COLOANE):
                ind = i * self.NR_COLOANE + j

                if self.verif(self.matr, ind, 'X', 6):
                    return 'X'
                if self.verif(self.matr, ind, '0', 6):
                    return '0'
    ...
    def mutari(self, jucator):
        ...
        used = [False for i in range(self.NR_COLOANE)]

        for i in range(self.NR_LINII - 1, -1, -1):
            for j in range(self.NR_COLOANE - 1, -1, -1):
                
                matr_tabla_noua = self.matr.copy()

                ind = i * self.NR_COLOANE + j

                if not used[ind % self.NR_COLOANE] and matr_tabla_noua[ind] == Joc.GOL:

                    used[ind % self.NR_COLOANE] = True
                    matr_tabla_noua[ind] = jucator
    ...
    def nr_intervale_deschise(self, jucator):
        ...
        for i in range(self.NR_LINII):
            for j in range(self.NR_COLOANE - 3):
                ...
                if self.verif2(self.matr, ind, juc_opus, 1):
                    rez += 1
        ...
        for i in range(self.NR_LINII - 3):
            for j in range(self.NR_COLOANE):
                ...
                if self.verif2(self.matr, ind, juc_opus, 7):
                    rez += 1
        ...
        for i in range(self.NR_LINII - 3):
            for j in range(self.NR_COLOANE - 3):
                ...
                if self.verif2(self.matr, ind, juc_opus, 8):
                    rez += 1
        ...
        for i in range(self.NR_LINII - 3):
            for j in range(3, self.NR_COLOANE):
                ...
                if self.verif2(self.matr, ind, juc_opus, 6):
                    rez += 1
        ...
        if (stare_curenta.j_curent == Joc.JMIN):
            ...
            while not raspuns_valid:
                try:
                    ...
                    if 0 <= coloana and coloana < Joc.NR_COLOANE:
